...
public class FileArchiveService implements Service {
    ...
    public Collection<FileArchive> getAllArchives() throws SQLException {
    ...
    public void createArchive(String name) throws UserNotAuthorizedException, SQLException, NoSuchFieldException, IllegalAccessException {
        context.checkLogin();
    ...
    public void removeById(Long fileArchiveId) throws UserNotAuthorizedException, NotFoundException, NotAllowedExceptions, SQLException {
        context.checkLogin();
    ...
    public FileArchive update(Long fileArchiveId, String newName) throws UserNotAuthorizedException, NotFoundException, NotAllowedExceptions, SQLException, NoSuchFieldException, IllegalAccessException {
        context.checkLogin();
        ...
        return fileArchiveStorage.updateById(fileArchiveId, fileArchive);
    }
}
